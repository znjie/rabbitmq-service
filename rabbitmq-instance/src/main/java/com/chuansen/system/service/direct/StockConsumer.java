...
public class StockConsumer {
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        // 队列需要去关联交换机
        channel.queueBind(Constant.DIRECT_STOCK_QUEUE_NAME, Constant.DIRECT_EXCHANGE_NAME, Constant.DIRECT_STOCK_KRY);
        ...
        // 开始监听消息 自动签收
        channel.basicConsume(Constant.DIRECT_STOCK_QUEUE_NAME, true, defaultConsumer);
